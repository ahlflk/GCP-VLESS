...
case "${_opt:-2}" in
  1) PROTO="vless"     ; IMAGE="v2fly/v2fly-core:latest"     ;;
  2) PROTO="vless"     ; IMAGE="v2fly/v2fly-core:latest"     ;;
  3) PROTO="vless"     ; IMAGE="v2fly/v2fly-core:latest"     ;;
  *) PROTO="vless"     ; IMAGE="v2fly/v2fly-core:latest"     ;;
esac
ok "Selected ${PROTO^^}"
...
TROJAN_PATH="%2Ftrojan"  # Updated path for Trojan
